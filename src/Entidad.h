...
const short MASK_BULLET = CATEGORY_SCENERY | CATEGORY_PLAYER | CATEGORY_TRAMPA;
...
const short MASK_EXPLOSION = CATEGORY_PLAYER | CATEGORY_TRAMPA;
const short MASK_TRAMPA1 = CATEGORY_PLAYER;
const short MASK_TRAMPA2 = CATEGORY_PLAYER | CATEGORY_BULLET | CATEGORY_EXPLOSION;
const short MASK_INTANGIBLE = 0;
