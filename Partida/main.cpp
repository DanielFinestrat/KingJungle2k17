...
int main() {
    ...
    sueloFixtureDef.restitution = 0.01f;
    ...
    sueloBody->CreateFixture(&sueloFixtureDef);
    ...
    b2FixtureDef techoFixtureDef;
    techoFixtureDef.shape = &sueloBox;
    techoFixtureDef.friction = 0.8f;
    techoFixtureDef.restitution = 0.01f;
    techoFixtureDef.density = 0.7f;
    techoFixtureDef.filter.categoryBits = CATEGORY_SCENERY;
    techoFixtureDef.filter.maskBits = MASK_SCENERY;
    techoBody->CreateFixture(&techoFixtureDef);
    ...
    //Creamos un arma
    Weapon *weapon = new Weapon(&world, Vector2f(50, 30), Vector2f(screenWidth / 2, 200), 1.0f, 1, 10);
