...
sf::RectangleShape Update_Shape(Caja caixa){
        sf::RectangleShape rectCaja(caixa.m_Size);
...
int main() {
    ...
    //Crear Ventana
    RenderWindow Ventana(VideoMode(800,600),"Ejemplo proyectil");
    Ventana.setFramerateLimit(60);      //Hacer que los tiempos de refresco casen con los tiempos de Box2D
    ...
    while(Ventana.isOpen()){
        ...
        //Dibujamos un rectangulo que actuara de suelo más adelante
        ...
        rectSuelo.setFillColor(sf::Color::Blue);
