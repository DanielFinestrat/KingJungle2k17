...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/kotj_trampassiseven_actual_: /usr/lib/x86_64-linux-gnu/libsfml-network.so
...
${OBJECTDIR}/sourcefiles/Coin.o: sourcefiles/Coin.cpp 
	${MKDIR} -p ${OBJECTDIR}/sourcefiles
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/sourcefiles/Coin.o sourcefiles/Coin.cpp

${OBJECTDIR}/sourcefiles/Coinsspawner.o: sourcefiles/Coinsspawner.cpp 
	${MKDIR} -p ${OBJECTDIR}/sourcefiles
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/sourcefiles/Coinsspawner.o sourcefiles/Coinsspawner.cpp
...
${OBJECTDIR}/sourcefiles/Hud.o: sourcefiles/Hud.cpp 
	${MKDIR} -p ${OBJECTDIR}/sourcefiles
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/sourcefiles/Hud.o sourcefiles/Hud.cpp
...
${OBJECTDIR}/sourcefiles/Trampa.o: sourcefiles/Trampa.cpp 
	${MKDIR} -p ${OBJECTDIR}/sourcefiles
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/sourcefiles/Trampa.o sourcefiles/Trampa.cpp

${OBJECTDIR}/sourcefiles/TrapSpawner.o: sourcefiles/TrapSpawner.cpp 
	${MKDIR} -p ${OBJECTDIR}/sourcefiles
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/sourcefiles/TrapSpawner.o sourcefiles/TrapSpawner.cpp
