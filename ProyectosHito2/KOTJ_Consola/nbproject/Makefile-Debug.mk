...
${OBJECTDIR}/sourcefiles/Animation.o: sourcefiles/Animation.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/usr/include/SFML -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/sourcefiles/Animation.o sourcefiles/Animation.cpp
...
${OBJECTDIR}/sourcefiles/ContactListener.o: sourcefiles/ContactListener.cpp 
	${MKDIR} -p ${OBJECTDIR}/sourcefiles
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/usr/include/SFML -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/sourcefiles/ContactListener.o sourcefiles/ContactListener.cpp
...
${OBJECTDIR}/sourcefiles/SpriteAnimated.o: sourcefiles/SpriteAnimated.cpp 
	${MKDIR} -p ${OBJECTDIR}/sourcefiles
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/usr/include/SFML -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/sourcefiles/SpriteAnimated.o sourcefiles/SpriteAnimated.cpp

${OBJECTDIR}/sourcefiles/Temporizador.o: sourcefiles/Temporizador.cpp 
	${MKDIR} -p ${OBJECTDIR}/sourcefiles
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/usr/include/SFML -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/sourcefiles/Temporizador.o sourcefiles/Temporizador.cpp
...
${OBJECTDIR}/sourcefiles/tinystr.o: sourcefiles/tinystr.cpp 
	${MKDIR} -p ${OBJECTDIR}/sourcefiles
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/usr/include/SFML -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/sourcefiles/tinystr.o sourcefiles/tinystr.cpp

${OBJECTDIR}/sourcefiles/tinyxml.o: sourcefiles/tinyxml.cpp 
	${MKDIR} -p ${OBJECTDIR}/sourcefiles
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/usr/include/SFML -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/sourcefiles/tinyxml.o sourcefiles/tinyxml.cpp

${OBJECTDIR}/sourcefiles/tinyxmlerror.o: sourcefiles/tinyxmlerror.cpp 
	${MKDIR} -p ${OBJECTDIR}/sourcefiles
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/usr/include/SFML -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/sourcefiles/tinyxmlerror.o sourcefiles/tinyxmlerror.cpp

${OBJECTDIR}/sourcefiles/tinyxmlparser.o: sourcefiles/tinyxmlparser.cpp 
	${MKDIR} -p ${OBJECTDIR}/sourcefiles
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/usr/include/SFML -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/sourcefiles/tinyxmlparser.o sourcefiles/tinyxmlparser.cpp
