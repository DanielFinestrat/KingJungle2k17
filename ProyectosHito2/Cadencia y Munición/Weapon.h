...
class Weapon {
    public:
        ...
        sf::Texture texture; // Textura de nuestro arma
        ...
        /**
         * Comprueba la cadencia de tiro para decidir si instanciar una bala o no hacerlo
         ...
         * @param b2World world: mundo en el que se van a crear las balas
         */
        void instantiateBullet(b2World *world);
