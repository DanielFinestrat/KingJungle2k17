...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/kotj_menu_cargamapas

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/kotj_menu_cargamapas: libBox2D.a

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/kotj_menu_cargamapas: /usr/lib/x86_64-linux-gnu/libsfml-audio.so

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/kotj_menu_cargamapas: /usr/lib/x86_64-linux-gnu/libsfml-graphics.so

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/kotj_menu_cargamapas: /usr/lib/x86_64-linux-gnu/libsfml-system.so

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/kotj_menu_cargamapas: /usr/lib/x86_64-linux-gnu/libsfml-window.so

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/kotj_menu_cargamapas: ${OBJECTFILES}
	${MKDIR} -p ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}
	${LINK.cc} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/kotj_menu_cargamapas ${OBJECTFILES} ${LDLIBSOPTIONS}
...
${OBJECTDIR}/motorfisico/sourcefiles/Motorfisico.o: motorfisico/sourcefiles/Motorfisico.cpp 
	${MKDIR} -p ${OBJECTDIR}/motorfisico/sourcefiles
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/usr/include/SFML -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/motorfisico/sourcefiles/Motorfisico.o motorfisico/sourcefiles/Motorfisico.cpp
...
${OBJECTDIR}/motorgrafico/sourcefiles/InnerClock.o: motorgrafico/sourcefiles/InnerClock.cpp 
	${MKDIR} -p ${OBJECTDIR}/motorgrafico/sourcefiles
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/usr/include/SFML -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/motorgrafico/sourcefiles/InnerClock.o motorgrafico/sourcefiles/InnerClock.cpp
...
${OBJECTDIR}/motorgrafico/sourcefiles/Texto.o: motorgrafico/sourcefiles/Texto.cpp 
	${MKDIR} -p ${OBJECTDIR}/motorgrafico/sourcefiles
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/usr/include/SFML -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/motorgrafico/sourcefiles/Texto.o motorgrafico/sourcefiles/Texto.cpp
...
${OBJECTDIR}/motorgrafico/sourcefiles/musicPlayer.o: motorgrafico/sourcefiles/musicPlayer.cpp 
	${MKDIR} -p ${OBJECTDIR}/motorgrafico/sourcefiles
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/usr/include/SFML -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/motorgrafico/sourcefiles/musicPlayer.o motorgrafico/sourcefiles/musicPlayer.cpp

${OBJECTDIR}/motorgrafico/sourcefiles/resources.o: motorgrafico/sourcefiles/resources.cpp 
	${MKDIR} -p ${OBJECTDIR}/motorgrafico/sourcefiles
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/usr/include/SFML -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/motorgrafico/sourcefiles/resources.o motorgrafico/sourcefiles/resources.cpp
...
${OBJECTDIR}/sourcefiles/Controlador.o: sourcefiles/Controlador.cpp 
	${MKDIR} -p ${OBJECTDIR}/sourcefiles
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/usr/include/SFML -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/sourcefiles/Controlador.o sourcefiles/Controlador.cpp

${OBJECTDIR}/sourcefiles/Entidad.o: sourcefiles/Entidad.cpp 
	${MKDIR} -p ${OBJECTDIR}/sourcefiles
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/usr/include/SFML -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/sourcefiles/Entidad.o sourcefiles/Entidad.cpp

${OBJECTDIR}/sourcefiles/Explosion.o: sourcefiles/Explosion.cpp 
	${MKDIR} -p ${OBJECTDIR}/sourcefiles
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/usr/include/SFML -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/sourcefiles/Explosion.o sourcefiles/Explosion.cpp

${OBJECTDIR}/sourcefiles/Mapa.o: sourcefiles/Mapa.cpp 
	${MKDIR} -p ${OBJECTDIR}/sourcefiles
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/usr/include/SFML -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/sourcefiles/Mapa.o sourcefiles/Mapa.cpp

${OBJECTDIR}/sourcefiles/Menu.o: sourcefiles/Menu.cpp 
	${MKDIR} -p ${OBJECTDIR}/sourcefiles
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/usr/include/SFML -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/sourcefiles/Menu.o sourcefiles/Menu.cpp

${OBJECTDIR}/sourcefiles/Partida.o: sourcefiles/Partida.cpp 
	${MKDIR} -p ${OBJECTDIR}/sourcefiles
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/usr/include/SFML -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/sourcefiles/Partida.o sourcefiles/Partida.cpp

${OBJECTDIR}/sourcefiles/Platform.o: sourcefiles/Platform.cpp 
	${MKDIR} -p ${OBJECTDIR}/sourcefiles
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/usr/include/SFML -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/sourcefiles/Platform.o sourcefiles/Platform.cpp

${OBJECTDIR}/sourcefiles/Player.o: sourcefiles/Player.cpp 
	${MKDIR} -p ${OBJECTDIR}/sourcefiles
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/usr/include/SFML -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/sourcefiles/Player.o sourcefiles/Player.cpp

${OBJECTDIR}/sourcefiles/PlayerJoystick.o: sourcefiles/PlayerJoystick.cpp 
	${MKDIR} -p ${OBJECTDIR}/sourcefiles
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/usr/include/SFML -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/sourcefiles/PlayerJoystick.o sourcefiles/PlayerJoystick.cpp

${OBJECTDIR}/sourcefiles/PlayerKeyboard.o: sourcefiles/PlayerKeyboard.cpp 
	${MKDIR} -p ${OBJECTDIR}/sourcefiles
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/usr/include/SFML -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/sourcefiles/PlayerKeyboard.o sourcefiles/PlayerKeyboard.cpp
...
${OBJECTDIR}/tinyxml/sourcefiles/tinystr.o: tinyxml/sourcefiles/tinystr.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/usr/include/SFML -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/tinyxml/sourcefiles/tinystr.o tinyxml/sourcefiles/tinystr.cpp

${OBJECTDIR}/tinyxml/sourcefiles/tinyxml.o: tinyxml/sourcefiles/tinyxml.cpp 
	${MKDIR} -p ${OBJECTDIR}/tinyxml/sourcefiles
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/usr/include/SFML -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/tinyxml/sourcefiles/tinyxml.o tinyxml/sourcefiles/tinyxml.cpp

${OBJECTDIR}/tinyxml/sourcefiles/tinyxmlerror.o: tinyxml/sourcefiles/tinyxmlerror.cpp 
	${MKDIR} -p ${OBJECTDIR}/tinyxml/sourcefiles
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/usr/include/SFML -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/tinyxml/sourcefiles/tinyxmlerror.o tinyxml/sourcefiles/tinyxmlerror.cpp

${OBJECTDIR}/tinyxml/sourcefiles/tinyxmlparser.o: tinyxml/sourcefiles/tinyxmlparser.cpp 
	${MKDIR} -p ${OBJECTDIR}/tinyxml/sourcefiles
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/usr/include/SFML -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/tinyxml/sourcefiles/tinyxmlparser.o tinyxml/sourcefiles/tinyxmlparser.cpp
...
.clean-conf: ${CLEAN_SUBPROJECTS}
	...
	${RM} ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/kotj_menu_cargamapas
